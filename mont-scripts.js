...
keywords_map['canin_carnizza_cuel_sclaf']=['FORAN DAL MUS','SART','BLASIC','CIUC DAL CORVAT','PIC DI BABE','CUEL SCLAF','BLACK TRACKS','TROIS NERIS','ARMELLINI','CANIN BASSO','PICCO DI CARNIZZA','PICCO DI GRUBIA','SELLA GRUBIA','CASERA CANIN','CARNIZZA DEL CANIN','CANIN','RESIA'];
keywords_map['canin_pic_carnizza_portafoglio']=['FORAN DAL MUS','SART','BLASIC','CIUC DAL CORVAT','PIC DI BABE','CUEL SCLAF','BLACK TRACKS','TROIS NERIS','ARMELLINI','CANIN BASSO','PICCO DI CARNIZZA','PICCO DI GRUBIA','SELLA GRUBIA','CASERA CANIN','CARNIZZA DEL CANIN','CANIN','RESIA'];
...
keywords_map['capolago']=['ALPI CARNICHE','FORNI AVOLTRI','COLLINA','MONTI DI VOLAIA','CAPOLAGO'];
...
keywords_map['cima_preti_ovest']=['BIVACCO BARONI','FORCELLA DI COLLALTO','CIMA DI COLLALTO','TRIDENTE','VAL DEI PRETI','CIMA LASTE','BUS DEI FRATI','LUCA BASSO','VIA DEI CACCIATORI','VAL MONTINA','PARETE OVEST','CIMOLAIS','CLAUT','OLTREPIAVE','DOLOMITI FRIULANE','CIMA DEI PRETI'];
...
keywords_map['creta_forata_cresta_ovest']=['CIMA SAPPADA','MONTE GEU','PASSO GEU','GEU','VIA PATERA','CRESTA OVEST','FORCELLA CRETA FORATA','FORO','PASSADA','ALPI CARNICHE','CRETA FORATA'];
...
keywords_map['cristallino_cengia_raule']=['PUNTA MOSCA','PUNTA CLEMENTINA','PUNTA ELFIE','VAL DE LE BANCE','MONTE POPENA','PIZ POPENA','CRISTALLO','GRANDE CENGIA','CENGIA RAULE','MISURINA','CRISTALLINO'];
...
keywords_map['indrinizza']=['RESIA','RACCOLANA','ALPI GIULIE','CANIN','FORAN DAL MUS','BLASIC','PICCO DI GRUBIA','CUEL SCLAF','FORCHIA DI TERRAROSSA','TAMAROTS','TAMAROZ','PECEIT','PEZZEIT','SELLA BUIA','HLABUJA','COSTA DI SART','SDRINIZE','INDRINIZZA','SART'];
...
keywords_map['laste_cresta_nord']=['BERTI-TARRA','CRESTA NORD','COLLALTO','COLALTO','BELLO','BOSCO DEL BELO','CADIN DI GEA','CIMA GEA','FORCELLA DEI FRASSIN','VAL DEI FRASSIN','CIMOLAIS','CLAUT','VAL CIMOLIANA','MONTINA','DURANNO','CIMA DEI FRATI','CIMA DEI PRETI','CIMA LASTE'];
...
keywords_map['marmarole_froppa_anello']=['VALLON DEL FROPPA','FORCELLA MARMAROLE','BIVACCO FANTON','JAU DELLA TANA','MONTICELLO','CIMA DI VALLONGA','FORCELLA VALLONGA','PALA DI MEDUCE','CIMA TIZIANO','BASTIONI','FORCELLA PICCOLA','ANTELAO','RIFUGIO CHIGGIATO','CIMON DEL FROPPA','MONTE FROPPA','VAL DOTEN','CALALZO','MARMAROLE'];
...
keywords_map['monviso_2025']=['LAGO FIORENZA','LAGO CHIARETTO','COLLE DI VISO','LAGO DI VISO','RIFUGIO QUINTINO SELLA','ALPI OCCIDENTALI','ALPI COZIE','PIEMONTE','PASSO DELLE SAGNETTE','VISO DI VALLANTA','VISO','MONVISO'];
...
keywords_map['navastolt']=['SAPPADA','CARNICHE','FORCELLA DEL BUSO','CRASSIGNE DAL CRAMAR','CENGIA DEL SOLE','AVANZA','NAVASTOLT'];
...
keywords_map['pic_di_babe']=['ALPI GIULIE','VAL RACCOLANA','CALDERINO ROBEL','CUEL SCLAF','CIUC DAL CORVAT','GRANDE POIZ','BUSE DA LI BURALIS','GORIUDA','GORIUDE','GRANDE POIZ','STAVOLO BABE','STAVOLO BABA','PIANI','PIC BABE','PIC DI BABE'];
...
keywords_map['tauri_2025_elberfelder_salm']=['PASTERZE','MARGARITZEN','LIENZ','HEILIGENBLUT','GOSSNITZ','ELBERFELDERHUTTE','GLORERHUTTE','SALMHUTTE','GROSSGLOCKNER','ALTI TAURI'];
...
keywords_map['troi_cuelat']=['ALPI GIULIE','VAL RACCOLANA','STRADE DAI CJARNEI','GORIUDA','GORIUDE','PIC DI BABE','SART','CALDERINO ROBEL','BLASIC','CUELAT','RIO DE LA CALADA','PIANI DEL MONTASIO','PIANI DI LA','ARMELLINI','TROIS NERIS','BLACK TRACKS','TROI DAL CUELAT'];
